 ...
 * @author Ana Beatriz
 */
public class MenuAdministrador_AdmEstagiario extends javax.swing.JFrame {
    private Dono dono;
    /**
     * Creates new form MenuDono_AdmEstagiario
     */
    public MenuAdministrador_AdmEstagiario(String cpf) {
        if(cpf != null){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuAdministrador_AdmEstagiario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuAdministrador_AdmEstagiario(null).setVisible(true);
            }
        });
    }
