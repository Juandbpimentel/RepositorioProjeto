 ...
 * @author Ana Beatriz
 */
public class MenuAdministrador_AdmDiretor extends javax.swing.JFrame {
    private Dono dono;
    /**
     * Creates new form MenuDono_AdmDiretor
     */
    public MenuAdministrador_AdmDiretor(String cpf) {
        if(cpf != null){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuAdministrador_AdmDiretor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new MenuAdministrador_AdmDiretor().setVisible(true);
            }
        });
    }
