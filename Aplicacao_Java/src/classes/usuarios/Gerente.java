...
public class Gerente extends Funcionario implements GerenteGUI,GerenteAlterDB {
    ...
    public Gerente(double bonificacao, Categoria categoria, Collection<Estagiario> estagiarios, double bonificacaoGerente) {
        super(bonificacao, categoria, estagiarios);
        this.bonificacaoGerente = bonificacaoGerente;
    }

    public Gerente(String nome, String login, String senha, String tipo, String cpf, LocalDate dataNasc, Endereco endereco, Conexao conexao, double bonificacao, Categoria categoria, Collection<Estagiario> estagiarios, double bonificacaoGerente) {
